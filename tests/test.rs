...
mod tests {
    ...
    use gamuboy::{config::Config, gameboy::GameBoy, joypad_events_handler, lcd, saver, stereo};

    const ROMS_PATH: &'static str = concat!(env!("CARGO_MANIFEST_DIR"), "/tests/roms");

    fn test_rom(component_name: &str, rom_name: &str, timeout: Duration) {
        let rom = fs::read(
            Path::new(ROMS_PATH)
                .join(component_name)
                .join(rom_name)
    ...
    fn test_blargg_roms_cpu_instrs_05_op_rp() {
        test_rom("blargg/cpu_instrs", "05-op rp.gb", Duration::from_secs(30));
    }

    #[test]
    fn test_blargg_roms_cpu_instrs_06_ld_r_r() {
        test_rom("blargg/cpu_instrs", "06-ld r,r.gb", Duration::from_secs(30));
    }
    ...
    fn test_blargg_roms_cpu_instrs_09_op_r_r() {
        test_rom("blargg/cpu_instrs", "09-op r,r.gb", Duration::from_secs(30));
    }
    ...
    fn test_blargg_roms_interrupt_time() {
        // output reports "Failed" because double speed is required to validate test checksum (so cannot pass on DMG)
        test_rom(
    ...
    fn test_blargg_roms_dmg_sound_02_len_ctr() {
        test_rom("blargg/dmg_sound", "02-len ctr.gb", Duration::from_secs(30));
    }

    #[test]
    fn test_blargg_roms_dmg_sound_03_trigger() {
        test_rom("blargg/dmg_sound", "03-trigger.gb", Duration::from_secs(40));
    }

    #[test]
    fn test_blargg_roms_dmg_sound_04_sweep() {
        test_rom("blargg/dmg_sound", "04-sweep.gb", Duration::from_secs(30));
    }
    ...
    fn test_mooneye_roms_mbc1_bits_bank1() {
        test_rom("mooneye/mbc1", "bits_bank1.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_bits_bank2() {
        test_rom("mooneye/mbc1", "bits_bank2.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_bits_mode() {
        test_rom("mooneye/mbc1", "bits_mode.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_bits_ramg() {
        test_rom("mooneye/mbc1", "bits_ramg.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_ram_64kb() {
        test_rom("mooneye/mbc1", "ram_64kb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_ram_256kb() {
        test_rom("mooneye/mbc1", "ram_256kb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_1mb() {
        test_rom("mooneye/mbc1", "rom_1Mb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_2mb() {
        test_rom("mooneye/mbc1", "rom_2Mb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_4mb() {
        test_rom("mooneye/mbc1", "rom_4Mb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_8mb() {
        test_rom("mooneye/mbc1", "rom_8Mb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_16mb() {
        test_rom("mooneye/mbc1", "rom_16Mb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc1_rom_512kb() {
        test_rom("mooneye/mbc1", "rom_512kb.gb", Duration::from_secs(15));
    }

    #[test]
    fn test_mooneye_roms_mbc2_bits_ramg() {
        test_rom("mooneye/mbc2", "bits_ramg.gb", Duration::from_secs(10));
    }

    #[test]
    fn test_mooneye_roms_mbc2_bits_romb() {
        test_rom("mooneye/mbc2", "bits_romb.gb", Duration::from_secs(10));
    }

    #[test]
    fn test_mooneye_roms_mbc2_bits_unused() {
        test_rom("mooneye/mbc2", "bits_unused.gb", Duration::from_secs(10));
    }

    #[test]
    fn test_mooneye_roms_mbc2_ram() {
        test_rom("mooneye/mbc2", "ram.gb", Duration::from_secs(10));
    }

    #[test]
    fn test_mooneye_roms_mbc2_rom_1mb() {
        test_rom("mooneye/mbc2", "rom_1Mb.gb", Duration::from_secs(10));
    }

    #[test]
    fn test_mooneye_roms_mbc2_rom_2mb() {
        test_rom("mooneye/mbc2", "rom_2Mb.gb", Duration::from_secs(10));
    }
